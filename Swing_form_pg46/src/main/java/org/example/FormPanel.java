    ...
    public FormPanel() {
        ...
        ActionListener al = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                String tf2 = occupation.getText() + ": ";
                String tf3 = list.list.getSelectedValue();
                String emp = comboList[employment.getSelectedIndex()] + ": ";
                if (clickedButton == ok) {
                    StringEvent se1 = new StringEvent(name, tf1);
                    StringEvent se2 = new StringEvent(occupation, tf2);
                    StringEvent se3 = new StringEvent(list, tf3);
                    StringEvent se4 = new StringEvent(employment, emp);
                    sl.textEmitted(se1);
                    sl.textEmitted(se2);
                    sl.textEmitted(se3);
                    sl.textEmitted(se4);
